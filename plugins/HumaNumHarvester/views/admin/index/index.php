...
$head = array('title'      => 'Huma-Num Harvester',
...
<img src="/plugins/HumaNumHarvester/images/logo-huma-num.png" style="width:300px; margin-bottom:40px;"/>
<?php echo flash(); ?>
    <h2>Data Provider</h2>
        ...
        <?php foreach ($this->harvests as $harvest): ?>
            <tr>
                ...
                <td class="harvest-status">
                    <a href="<?php echo url("huma-num-harvester/index/status?harvest_id={$harvest->id}"); ?>"><?php echo html_escape(ucwords($harvest->status)); ?></a>
                    <?php if ($harvest->status == OaipmhHarvester_Harvest::STATUS_COMPLETED): ?>
                        <br>
                        <form method="post" action="<?php echo url('huma-num-harvester/index/harvest');?>">
